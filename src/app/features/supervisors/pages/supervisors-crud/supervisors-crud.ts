    ...
    template: `
        <p-toolbar styleClass="mb-6">
            <ng-template #start>
                ...
                <p-button severity="secondary" label="Delete" icon="pi pi-trash" outlined (onClick)="deleteSelectedSupervisors()" [disabled]="!selectedSupervisors || !selectedSupervisors.length" />
            </ng-template>
        ...
        >
            <ng-template #caption>
                <div class="flex items-center justify-between">
                    <h5 class="m-0">Manage Supervisors</h5>
                    <p-iconfield>
        ...
        <p-dialog [(visible)]="supervisorDialog" [style]="{ width: '780px' }" header="Supervisor Details" [modal]="true">
            <ng-template #content>
                            ...
                            <p-step-panel [value]="3">
                                <ng-template #content>
                                    ...
                                    <div class="flex justify-between gap-2 mt-6">
                                        ...
                                        <p-button label="Save" icon="pi pi-check" (onClick)="saveSupervisor()" *ngIf="!viewOnly" [loading]="submitting" [disabled]="submitting"></p-button>
                                    </div>
                                </ng-template>
                            </p-step-panel>
                        </p-step-panels>
...
export class SupervisorsCrud implements OnInit {
    ...
    deleteSelectedSupervisors() {
        this.confirmationService.confirm({
            message: 'Are you sure you want to delete the selected supervisors?',
            header: 'Confirm',
    ...
    deleteSupervisor(supervisor: Supervisor) {
        this.confirmationService.confirm({
            message: 'Are you sure you want to delete ' + supervisor.username + '?',
            header: 'Confirm',
            icon: 'pi pi-exclamation-triangle',
            accept: () => {
